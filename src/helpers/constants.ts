...
export let defaultLiquidationIncentive: BigDecimal = mantissaBd.plus(BigInt.fromI32(10).pow(17).toBigDecimal());
export let fintrollerDefaultId: string = "1";
export let fyTokenDecimals = 18;
export let fyTokenDecimalsBd: BigDecimal = mantissaBd;
